...
export const currencies: Currency[] = [
  ...
  // ADICIONADAS: Stablecoins para aparecerem no conversor
...
// Atualizei os valores base para ficarem próximos da tua realidade atual
const baseRates: Record<string, number> = {
  USD: 1,
  EUR: 0.92,
  AOA: 1210, // Kwanza base
  BRL: 5.0,
  USDT: 1,
  USDC: 1,
  GBP: 0.79,
...
/* O restante das funções (fetchRates, fetchLiveRate, etc) permanecem iguais */
...
export async function fetchLiveRate(from: string, to: string): Promise<number> {
  ...
  if (!rates[to]) throw new Error("Rate unavailable");
  return rates[to];
}
